...
export const metadata: Metadata = {
  title: "Certificats GIA vs HRD vs SSEF : Quel Impact sur la Revente à Strasbourg ? | Rachat Bijoux Strasbourg",
  description: "Comparatif des plus grands laboratoires gemmologiques mondiaux et de leur influence sur la liquidité et le prix de vos diamants en Alsace.",
  alternates: { canonical: `${site.url}/blog/certificats-gia-vs-hrd-strasbourg` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'certificats-gia-vs-hrd-strasbourg');
  if (!post) notFound();
