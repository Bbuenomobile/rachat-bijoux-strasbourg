...
export const metadata: Metadata = {
  title: "Vendre une Montre de Luxe à Strasbourg : Rolex, Patek Philippe, Cartier & Omega | Rachat Bijoux Strasbourg",
  description: "Guide d'expertise et de vente directe de haute horlogerie suisse à Strasbourg : modèles recherchés, état d'origine et valorisation full set.",
  alternates: { canonical: `${site.url}/blog/vendre-montre-luxe-rolex-patek-strasbourg` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'vendre-montre-luxe-rolex-patek-strasbourg');
  if (!post) notFound();
