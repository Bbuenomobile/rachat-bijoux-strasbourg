...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${site.url}/blog/vendre-montre-luxe-rolex-patek-richard-mille-strasbourg` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'vendre-montre-luxe-rolex-patek-richard-mille-strasbourg');
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/vendre-montre-luxe-rolex-patek-richard-mille-strasbourg`,
  };
        ...
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              ...
              source="blog:vendre-montre-luxe-rolex-patek-richard-mille-strasbourg"
            />
          </div>
        </div>
      </Section>
