...
export const metadata: Metadata = {
  title: "Fiscalité de l'Or en France : TMP vs TPV, Lingots et Pièces d'Investissement | Rachat Bijoux Strasbourg",
  description: "Comprendre les règles fiscales applicables à la revente d'or d'investissement en France : taxe forfaitaire ou régime réel des plus-values.",
