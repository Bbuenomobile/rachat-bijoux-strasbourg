...
export const metadata: Metadata = {
  title: "Haute Joaillerie Signée : Cartier, Van Cleef & Arpels, Boucheron à Strasbourg | Rachat Bijoux Strasbourg",
  description: "Pourquoi les créations des grandes maisons de la Place Vendôme conservent une prime de collection bien supérieure au seul poids de l'or.",
  alternates: { canonical: `${site.url}/blog/valeur-haute-joaillerie-signee-cartier-van-cleef-strasbourg` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'valeur-haute-joaillerie-signee-cartier-van-cleef-strasbourg');
  if (!post) notFound();
