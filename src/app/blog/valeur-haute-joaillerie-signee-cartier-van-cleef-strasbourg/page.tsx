...
export default function BlogPostPage() {
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/valeur-haute-joaillerie-signee-cartier-van-cleef-strasbourg`,
  };
        ...
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              ...
              source="blog:valeur-haute-joaillerie-signee-cartier-van-cleef-strasbourg"
            />
          </div>
        </div>
      </Section>
